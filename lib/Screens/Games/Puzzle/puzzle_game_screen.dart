...
import 'package:mysaiph/Models/puzzle_game/move_to.dart';
...
class _PuzzleGameScreenState extends State<PuzzleGameScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //final String userId="gZhOPb99u1KESMM78DNY";
        ...
        controller.onFinish.listen(
            ...
            Timer(
              const Duration(
                ...
                //PuzzleGameService().setNewScore(widget.score!, userId);
                if (resultLevel == 0) {
                  showCustomDialog(context,
                      title: "Félicitations!",
                      body: dialogBody(context, controller.time.value, controller.state.moves),
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  const TimeWidget(),const SizedBox(height: 20,)
                                ],
                              ),
                            ),
                          );
