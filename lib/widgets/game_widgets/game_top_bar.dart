          ...
          children: [
            if(onPressedRestart != null)
              GestureDetector(
                  ...
                  child: !title.contains("PUZZLE")?SvgPicture.asset('assets/images/restart_icon.svg', width: screenWidth*0.1, height: screenWidth*0.1,):state!.puzzle.isTheFirstPic
                      ? SvgPicture.asset('assets/images/play.svg',
                      width: screenWidth * 0.1)
                      : state.status == GameStatus.playing
                      ? SvgPicture.asset('assets/images/restart_icon.svg',
                      width: screenWidth * 0.1)
                      : SvgPicture.asset('assets/images/play.svg',
                      width: screenWidth * 0.1)),
            ...
            if(onPressedClose != null)
             GestureDetector(
                 ...
                 child: SvgPicture.asset('assets/images/close_icon.svg', width: screenWidth*0.1, height: screenWidth*0.1,)
             ),
          ],
        )
      ],
